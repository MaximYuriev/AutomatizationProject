...
export const Witnes = () => {
    ...
    const getWitnes = async () => {
        const response = await fetch(`http://localhost:8000/algorithm/quest_person/${id}/7`)
    ...
    const downloadDocument = async () =>{
        ...
        if (response.ok)
        {
            ...
            a.download = `Протокол допроса свидетеля.docx`;
            a.click();
        ...
        return ( 
            <React.Fragment key={method.id_quest}>
                <TableBody>
                    ...
                    <TableRow>
                        <TableCell sx={{fontSize:'20px',textAlign:'left',border:1,width:'30%'}} size="small">Показания свидетеля</TableCell>
    ...
    return (
            <div className='form'>
                ...
                <Button variant="contained" color='secondary' size='large' sx={{marginTop:5,marginLeft:1}} type='submit' disabled={selectedId=='No'?true:false} onClick={()=>handleOpenEditWitnes()}>Изменить</Button>
                ...
                <dialog id='create' style={{verticalAlign:'center',margin:'auto',marginLeft:'auto'}}>
                    <h2 style={{textAlign:'center',width:"400px"}}>Добавление свидетеля</h2>
                ...
                <dialog id='edit' style={{verticalAlign:'center',margin:'auto',marginLeft:'auto'}}>
                    ...
                    <Content classname={'no'} submit={handleSubmit(editWitnes)}>
                        <div className='maindiv' style={{textAlign:'center',marginTop:'10px',height:'800px'}}>
                            ...
                            <Button variant="contained" color='error' size='large' sx={{marginTop:2,marginBottom:2,marginLeft:1}} onClick={()=>{handleCloseEditWitnes()}}type='reset'>Отмена</Button>
                        </div> 
                    </Content>
                </dialog>
            </div>
        ...
        return(
            <Content submit={handleSubmit(submitMethod)}>
                ...
                <div className="maindiv">
                    ...
                    <div className='formdiv'>
                        <label>Показания свидетеля</label>
                        <textarea className="textarea" {...register("establish")} placeholder="Показания свидетеля"></textarea>
                    </div>
                    <div className='formdiv'>
